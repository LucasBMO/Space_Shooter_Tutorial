...
def main():
    ...
    def redraw_window():
        WIN.blit(BG, (0, 0))
        # draw text
        lives_label = main_font.render(f'Lives: {lives}', True, (255, 255, 255))  # RGB colors(R - red, G - green, B - blue)
    ...
    while run:
        ...
        if len(enemies) == 0:
            ...
            for i in range(wave_length):
                enemy = Enemy(random.randrange(50, WIDTH - 100), random.randrange(-1400, -100), random.choice(['red', 'blue', 'green']))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0, 0))
        title_label = title_font.render('Press the mouse button...', True, (255, 255, 255))
